...
***    how to add a new Folder to your favorite-directories
   ...
   | anything_favorite_directories_visit  | visit selected directory                          |
   | anything_favorite_directories_delete | delete select directory from favorite directories |
   | anything_favorite_directories_add    | add a new directory to favorite directories       |
